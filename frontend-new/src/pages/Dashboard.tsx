          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
            ...
            <Link to="/sinifa-katil">
              ...
              >
                ...
                <div>
                  <h3 className="font-sans font-medium text-ink">Sinifa Katil</h3>
                  <p className="text-sm text-neutral-500">Kod ile katil</p>
                </div>
              </Card>
            </Link>
            ...
            <Link to="/siniflarim">
              ...
              >
                ...
                <div>
                  <h3 className="font-sans font-medium text-ink">Siniflarim</h3>
                  <p className="text-sm text-neutral-500">Kayitli siniflar</p>
                </div>
              </Card>
            </Link>
            ...
            <Link to="/kazanimlar">
              <Card
                variant="surface"
                hover
                className="flex items-center gap-4 animate-enter animate-delay-300"
              >
            ...
            <Link to="/oneriler">
              <Card
                variant="surface"
                hover
                className="flex items-center gap-4 animate-enter animate-delay-400"
              >
